...
class BooksDataSourceTester(unittest.TestCase):
    ...
    def test_books_with_search_text(self):
        self.assertEqual(self.booksdatasource_checker.books(search_text="me"), [{'id': 4, 'title': 'Elmer Gantry', 'publication_year': 1927}, {'id': 6, 'title': 'Good Omens', 'publication_year': 1990}, {'id': 9, 'title': 'Love in the Time of Cholera', 'publication_year': 1985}])

    def test_books_by_year(self):
        self.assertEqual(self.booksdatasource_checker.books(start_year=1989, sort_by='year'), [{'id': 0, 'title': 'All Clear', 'publication_year': 2010},
            {'id': 3, 'title': 'Blackout', 'publication_year': 2010}, {'id': 6, 'title': 'Good Omens', 'publication_year': 1990}])
    ...
    def test_books_for_author(self):
        self.assertEqual(self.booksdatasource_checker.books_for_author(0), [{'id': 0, 'title': 'All Clear', 'publication_year': 2010}, {'id': 3, 'title': 'Blackout', 'publication_year': 2010}])
